...
namespace Kong
{
    ...
    public:
        ...
        static std::weak_ptr<KongTexture> GetOrLoadTexture_new(const std::string & texture_path);
        std::weak_ptr<KongTexture> GetTexture_new(const std::string & texture_path);
